...
bp_trsh = 25;            % Set the threshold value for the bad point detection.
...
%     resistance = resistance - 6.7; % 6.7 Ohm is the measured lead
    ...
    f_I_matrix = NaN(length(current_log),numberOfFrequencyPoints);
    f_peak_export = NaN(1,length(current_log));
    current_export = NaN(1,length(current_log));
    peak_power_export = NaN(1,length(current_log));
    int_power_export = NaN(1,length(current_log));
    linewidth_export = NaN(1,length(current_log));

    f_peak_export2 = NaN(1,length(current_log));
    current_export2 = NaN(1,length(current_log));
    peak_power_export2 = NaN(1,length(current_log));
    int_power_export2 = NaN(1,length(current_log));
    linewidth_export2 = NaN(1,length(current_log));
...
save('filename.dat','export_vector','-ascii','-append');
